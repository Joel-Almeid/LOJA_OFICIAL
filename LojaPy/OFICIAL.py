...
class App(tk.Tk):
    ...
    def tela_cadastro_funcionario(self):
        ...
        campos = ["Nome", "Apelido", "Cargo", "Senha", "Data de Nascimento", "CPF", "Telefone"]
    ...
    def cadastrar_funcionario(self, entradas):
        ...
        if valida(dados["CPF"]):
            func = Funcionario(dados["Nome"], dados["Apelido"], dados["Senha"], dados["Cargo"], dados["Data de Nascimento"], dados["CPF"], dados["Telefone"])
    ...
    def tela_cadastro_cliente(self):
        ...
        campos = ["Nome", "Data de Nascimento", "CPF", "Telefone", "Apelido", "Senha", "Endereço"]
        entradas = {campo: tk.Entry(self) for campo in campos}
        for campo, entrada in entradas.items():
            tk.Label(self, text=campo).pack()
            entrada.pack()
    ...
    def cadastrar_cliente(self, entradas):
        dados = {campo: entrada.get() for campo, entrada in entradas.items()}
        if valida(dados["CPF"]):
            cli = Cliente(dados["Nome"], dados["Data de Nascimento"], dados["CPF"], dados["Telefone"], dados["Apelido"], dados["Senha"], dados["Endereço"])
            clientes.append(cli)
    ...
    def tela_buscar_produto(self):
        ...
        nome_entry.pack()
        tk.Button(self, text="Buscar", command=lambda: self.buscar_produto_e_ver_descricao(nome_entry.get())).pack(pady=5)
        tk.Button(self, text="Voltar", command=self.voltar_menu_inicial).pack(pady=5)
    ...
    def adicionar_produto_carrinho(self):
        ...
        tk.Button(self, text="Adicionar", command=lambda: self.adicionar_ao_pedido(nome_entry.get(), int(quantidade_entry.get()))).pack(pady=5)
    ...
    def realizar_pedido_cliente(self):
        ...
        tk.Button(self, text="Finalizar Pedido", command=lambda: self.finalizar_pedido(pagamento_entry.get())).pack(pady=5)
        tk.Button(self, text="Voltar", command=self.menu_cliente).pack(pady=5)
    ...
    def alterar_endereco_cliente(self):
        ...
        endereco_entry.pack()
        tk.Button(self, text="Alterar", command=lambda: self.usuario_logado.alterar_endereco(endereco_entry.get())).pack(pady=5)
        tk.Button(self, text="Voltar", command=self.menu_cliente).pack(pady=5)
    ...
    def cadastrar_produto(self, entradas):
        ...
        try:
            ...
            prod = Produto(dados["ID do Produto"], dados["Nome"], preco, dados["Descrição"], dados["Tipo"], dados["Marca"], dados["Categoria"], quantidade)
    ...
    def buscar_cliente_por_nome(self, nome):
        for cliente in clientes:
            if cliente.nome == nome:
                messagebox.showinfo("Cliente Encontrado", f"Cliente encontrado: {cliente.nome}\nEmail: {cliente.email}\nEndereço: {cliente.endereco}")
                return
    ...
    def buscar_funcionario_por_nome(self, nome):
        for funcionario in funcionarios:
            if funcionario.nome == nome:
                messagebox.showinfo("Funcionário Encontrado", f"Funcionário encontrado: {funcionario.nome}\nEmail: {funcionario.email}\nCargo: {funcionario.cargo}")
                return
